...
def project_2020(request):
	template = 'twitter_network/project_2020.html'
	context = {}
	return render(request, template, context)

def elections_project(request):
	template = 'twitter_network/elections_project.html'
	context = {}
	return render(request, template, context)

def ferguson_project(request):
	template = 'twitter_network/ferguson_project.html'
	context = {}
	return render(request, template, context)
